...
The [‘gasp’](https://docs.microsoft.com/en-us/typography/opentype/spec/gasp) table values describe the combination of sizes at which hinting and anti-aliasing should be applied. These values are generally shared between the Roman and Italic Variable font styles. 
...
1. Open XML file in WordPad or any text editor that allows for search and replace
...
When hinting is completed on the Roman font style, take a note of the key height cvt values that are used, then edit the cvt table in the Italic Variable font, to match, _if appropriate._
...
Values in the GASP table, describe the combination of sizes at which hinting and anti-aliasing should be applied. These values are generally shared between the Roman and Italic Variable font styles. 
...
VTT allows you to Compile all of the necessary tables with one command. From the main menu, choose, 
