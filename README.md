...
In this case the code causes the accent to appear to high at higher resolution. 
...
Lets look at the y-direction code, for ‘edotaccent’ 0x117 (GID 217)
...
_The Function uses a measured outline distance of 172, from base glyph to the accent. This is correct for static fonts, as there is only one measurement, but incorrect when used in a variable font, where the distance from base glyph to accent can vary significantly._

In the Extrabold Variant the dot over the ‘e’ is designed to be much closer to the base glyph and the measured outline distance, is 90 Font Units. This design is correct for high resolution, where the accent in the Regular is higher, keeping the typographic colour of openness where as in the Extrabold design the accent needs to be much closer to maintain the right typographic colour.
